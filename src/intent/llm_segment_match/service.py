...
from src.intent.llm_segment_match.models import LLMSegmentMatchResult
...
class IntentSegmentMatchService:
    ...
    def time_match(self, intent: str, steps: List[RecipeStep]) -> LLMSegmentMatchResult:
        prompt = self.prompt_generator.generate_secondary_system_prompt(steps)
